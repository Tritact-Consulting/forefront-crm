                            ...
                            <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                ...
                                <div class="contact-wrapper">
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time">
                                                <img class="img-fluid rounded-circle" src="../assets/images/blog/14.png" alt="user">
                                                <div>
                                    ...
                                    <ul class="border-0">
                                        ...
                                        <li class="common-space">
                                            <div class="chat-time">
                                                <img class="img-fluid rounded-circle" src="../assets/images/user/3.png" alt="user">
                                                <div>
                                        ...
                                        <li class="common-space">
                                            <div class="chat-time">
                                                <img class="img-fluid rounded-circle" src="../assets/images/user/6.jpg" alt="user">
                                                <div>
                                                    <span>Darrell Steward</span>
                                                    <p>200-300-1030</p>
                                                </div>
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time">
                                                <img class="img-fluid rounded-circle" src="../assets/images/user/1.jpg" alt="user">
                                                <div>
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time">
                                                <img class="img-fluid rounded-circle" src="../assets/images/user/2.jpg" alt="user">
                                                <div>
                                                    <span>Fiona Cooper</span>
                                                    <p>362-778-1919</p>
                                                </div>
                                            </div>
                                            <div class="contact-edit">
                    ...
                    <div class="right-sidebar-title">
                        <div class="common-space">
                            <div class="chat-time group-chat">
                                ...
                                <div>
                                    <span class="f-w-600">Meeting Department</span>
                                    <p>35 Members</p>
                                </div>
                            </div>
