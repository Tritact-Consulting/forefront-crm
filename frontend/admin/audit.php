                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" id="profile-top-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="false"><i data-feather="info"></i>Progress</a></li>
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="btn btn-primary" href="add-audit.php"> <i data-feather="plus-square"> </i>Create New Audit</a>
                        </div>
                    </div>
                </div>
            </div>
